...
# THIS CODE EXPLORES A MULTIPLICITY OF OBSERVABLE TRAITS (FINGERPRINTS) FOR THE GENE REGULATORY NETWORK MODEL (Gao et al., 2016)
...
for ro in range(rounds):
    ...
    for z in range(points):
        ...
        for j in range(0,reps): 
            ...
            for neg in range(len(final_perturb)):
                if final_perturb[neg]<0.0:
                    final_perturb[neg]=0.0
            ###########################################################################################################
