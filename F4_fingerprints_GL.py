...
# THIS CODE EXPLORES A MULTIPLICITY OF OBSERVABLE TRAITS (FINGERPRINTS) FOR THE (HIGH-DIMENSIONAL) GARAY-LEFEVER CANCER-IMMUNE MODEL
...
meanmu = 1.4
varmu = varintra
mu=np.random.lognormal(mean=np.log(meanmu), sigma=np.log(varmu), size=SP)
