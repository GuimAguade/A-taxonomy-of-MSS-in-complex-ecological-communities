...
# THIS CODE EXPLORES A MULTIPLICITY OF OBSERVABLE TRAITS (FINGERPRINTS) FOR THE NEURAL NETWORK MODEL OF Stern et al., 2014
...
for ro in range(rounds):
    ...
    for z in range(points):
        ...
        for j in range(0,reps): 
            ...
            alivestate = [m for m in finalstate if m>0.0] #FOR EFFICIENCY PURPOSES: LIST OF ONLY SURVIVING SPP.'S ABUNDANCES
...
with open('Stern_FPS.csv', 'w') as f:
    writer = csv.writer(f)
